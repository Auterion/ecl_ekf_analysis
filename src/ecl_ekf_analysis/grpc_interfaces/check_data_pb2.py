...
_CHECKTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_TYPE_ECL_COMPASS_STATUS', index=1, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_TYPE_ECL_VELOCITY_SENSOR_STATUS', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_TYPE_ECL_POSITION_SENSOR_STATUS', index=3, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_TYPE_ECL_HEIGHT_SENSOR_STATUS', index=4, number=4,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_TYPE_ECL_HEIGHT_ABOVE_GROUND_SENSOR_STATUS', index=5, number=5,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_TYPE_ECL_AIRSPEED_SENSOR_STATUS', index=6, number=6,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_TYPE_ECL_SIDESLIP_SENSOR_STATUS', index=7, number=7,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_TYPE_ECL_IMU_VIBRATION_STATUS', index=8, number=8,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_TYPE_ECL_IMU_BIAS_STATUS', index=9, number=9,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_TYPE_ECL_IMU_OUTPUT_PREDICTOR_STATUS', index=10, number=10,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_TYPE_ECL_OPTICAL_FLOW_STATUS', index=11, number=11,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_TYPE_ECL_FILTER_FAULT_STATUS', index=12, number=12,
      options=None,
      type=None),
  ],
  containing_type=None,
...
CHECK_TYPE_ECL_COMPASS_STATUS = 1
CHECK_TYPE_ECL_VELOCITY_SENSOR_STATUS = 2
CHECK_TYPE_ECL_POSITION_SENSOR_STATUS = 3
CHECK_TYPE_ECL_HEIGHT_SENSOR_STATUS = 4
CHECK_TYPE_ECL_HEIGHT_ABOVE_GROUND_SENSOR_STATUS = 5
CHECK_TYPE_ECL_AIRSPEED_SENSOR_STATUS = 6
CHECK_TYPE_ECL_SIDESLIP_SENSOR_STATUS = 7
CHECK_TYPE_ECL_IMU_VIBRATION_STATUS = 8
CHECK_TYPE_ECL_IMU_BIAS_STATUS = 9
CHECK_TYPE_ECL_IMU_OUTPUT_PREDICTOR_STATUS = 10
CHECK_TYPE_ECL_OPTICAL_FLOW_STATUS = 11
CHECK_TYPE_ECL_FILTER_FAULT_STATUS = 12
