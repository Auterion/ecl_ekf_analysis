...
_CHECKSTATISTICTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_STATISTIC_TYPE_ECL_IMU_OBSERVED_ANGLE_ERROR_AVG', index=19, number=19,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_STATISTIC_TYPE_ECL_IMU_OBSERVED_ANGLE_ERROR_WINDOWED_AVG', index=20, number=20,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_STATISTIC_TYPE_ECL_IMU_OBSERVED_VELOCITY_ERROR_AVG', index=21, number=21,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_STATISTIC_TYPE_ECL_IMU_OBSERVED_VELOCITY_ERROR_WINDOWED_AVG', index=22, number=22,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_STATISTIC_TYPE_ECL_IMU_OBSERVED_POSITION_ERROR_AVG', index=23, number=23,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_STATISTIC_TYPE_ECL_IMU_OBSERVED_POSITION_ERROR_WINDOWED_AVG', index=24, number=24,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_STATISTIC_TYPE_ECL_IMU_DELTA_ANGLE_BIAS_AVG', index=25, number=25,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_STATISTIC_TYPE_ECL_IMU_DELTA_ANGLE_BIAS_WINDOWED_AVG', index=26, number=26,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_STATISTIC_TYPE_ECL_IMU_DELTA_VELOCITY_BIAS_AVG', index=27, number=27,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_STATISTIC_TYPE_ECL_IMU_DELTA_VELOCITY_BIAS_WINDOWED_AVG', index=28, number=28,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_STATISTIC_TYPE_ECL_FILTER_FAULT_FLAG', index=29, number=29,
      options=None,
      type=None),
  ],
...
CHECK_STATISTIC_TYPE_ECL_IMU_OBSERVED_ANGLE_ERROR_AVG = 19
CHECK_STATISTIC_TYPE_ECL_IMU_OBSERVED_ANGLE_ERROR_WINDOWED_AVG = 20
CHECK_STATISTIC_TYPE_ECL_IMU_OBSERVED_VELOCITY_ERROR_AVG = 21
CHECK_STATISTIC_TYPE_ECL_IMU_OBSERVED_VELOCITY_ERROR_WINDOWED_AVG = 22
CHECK_STATISTIC_TYPE_ECL_IMU_OBSERVED_POSITION_ERROR_AVG = 23
CHECK_STATISTIC_TYPE_ECL_IMU_OBSERVED_POSITION_ERROR_WINDOWED_AVG = 24
CHECK_STATISTIC_TYPE_ECL_IMU_DELTA_ANGLE_BIAS_AVG = 25
CHECK_STATISTIC_TYPE_ECL_IMU_DELTA_ANGLE_BIAS_WINDOWED_AVG = 26
CHECK_STATISTIC_TYPE_ECL_IMU_DELTA_VELOCITY_BIAS_AVG = 27
CHECK_STATISTIC_TYPE_ECL_IMU_DELTA_VELOCITY_BIAS_WINDOWED_AVG = 28
CHECK_STATISTIC_TYPE_ECL_FILTER_FAULT_FLAG = 29
