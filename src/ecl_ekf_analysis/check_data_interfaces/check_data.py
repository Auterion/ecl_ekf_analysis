...
class CheckStatisticType(IntEnum):
    ...
    FAIL_RATIO_SHORT_WINDOW_PCT = 30
    FAIL_RATIO_LONG_WINDOW_PCT = 31
...
class CheckType(IntEnum):
    ...
    GPS_VELOCITY_STATUS = 14
    GPS_POSITION_STATUS = 15
    EXTERNAL_VISION_VELOCITY_STATUS = 16
    EXTERNAL_VISION_POSITION_STATUS = 17
    GPS_HEIGHT_STATUS = 18
    EXTERNAL_VISION_HEIGHT_STATUS = 19
    BAROMETER_HEIGHT_STATUS = 20
    RANGE_SENSOR_HEIGHT_STATUS = 21
