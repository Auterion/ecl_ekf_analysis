...
class EstimatorCheck(Check):
    ...
    def __init__(
        self,
        ulog: ULog,
        innov_flags: Dict[str, float],
        control_mode_flags: Dict[str, float],
        ...
        """
        super().__init__(ulog, check_type=check_type)
    ...
    def calc_test_ratio_metrics(self, test_ratio_name: str) -> Dict[str, list]:
        ...
        test_ratio_metrics[
            ...
            threshold=params.ecl_red_thresh(),
        ...
        test_ratio_metrics[
            ...
            test_ratio_name,
            self._in_air_detector,
            threshold=params.ecl_amb_thresh(),
            window_len_s=params.ecl_window_len_s(),
        )
        ...
        for i, test_ratio_name in enumerate(self._test_ratio_names):
            ...
            innov_red_windowed_pct.value = float(
                max(
                    [
                        np.max(metric)
                        for _, metric in test_ratio_metrics[
                            '{:s}_percentage_red_windowed'.format(self._check_id)
                        ]
                    ]
                )
        ...
        for i, innov_fail_name in enumerate(self._innov_fail_names):
            ...
            innov_stats_fail_windowed_pct.value = float(
                max(
                    [
                        np.max(metric)
                        for _, metric in innovation_metrics[
                            '{:s}_windowed_mean'.format(innov_fail_name)
                        ]
                    ]
                )
...
class GPSVelocityCheck(EstimatorCheck):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            check_id='gps_velocity',
            test_ratio_name='gps_vel',
        )
    ...
    def run_precondition(self) -> bool:
        ...
        return (
            'estimator_innovations' in messages
            and np.amax(self._control_mode_flags['using_gps']) > 0.5
        )
...
class EVVelocityCheck(EstimatorCheck):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            check_id='ev_velocity',
            test_ratio_name='ev_vel',
        )
    ...
    def run_precondition(self) -> bool:
        ...
        return (
            'estimator_innovations' in messages
            and np.amax(self._control_mode_flags['ev_vel']) > 0.5
        )
...
class PositionCheck(EstimatorCheck):
    ...
    def run_precondition(self) -> bool:
        ...
        """
        return (
            params.ecl_pos_checks_when_sensors_not_fused()
            or np.amax(self._control_mode_flags['using_gps']) > 0.5
            or np.amax(self._control_mode_flags['using_evpos']) > 0.5
        )
...
class GPSPositionCheck(EstimatorCheck):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            check_id='gps_position',
            test_ratio_name='gps_hpos',
        )
...
class EVPositionCheck(EstimatorCheck):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            check_id='ev_position',
            test_ratio_name='ev_hpos',
        )
    ...
    def run_precondition(self) -> bool:
        ...
        return (
            'estimator_innovations' in messages
            and np.amax(self._control_mode_flags['using_evpos']) > 0.5
        )
...
class GPSHeightCheck(EstimatorCheck):
    ...
    def run_precondition(self) -> bool:
        ...
        return (
            'estimator_innovations' in messages
            and np.amax(self._control_mode_flags['using_gpshgt']) > 0.5
        )
...
class EVHeightCheck(EstimatorCheck):
    ...
    def run_precondition(self) -> bool:
        ...
        return (
            'estimator_innovations' in messages
            and np.amax(self._control_mode_flags['using_evhgt']) > 0.5
        )
...
class BarometerHeightCheck(EstimatorCheck):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            check_id='baro_height',
            test_ratio_name='baro_vpos',
        )
    ...
    def run_precondition(self) -> bool:
        ...
        return (
            'estimator_innovations' in messages
            and np.amax(self._control_mode_flags['using_barohgt']) > 0.5
        )
...
class RangeSensorHeightCheck(EstimatorCheck):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            check_id='range_sensor_height',
            test_ratio_name='rng_vpos',
        )
    ...
    def run_precondition(self) -> bool:
        ...
        return (
            'estimator_innovations' in messages
            and np.amax(self._control_mode_flags['using_rnghgt']) > 0.5
        )
...
class HeightAboveGroundCheck(EstimatorCheck):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            check_id='height_above_ground',
            test_ratio_name='hagl',
    ...
    def run_precondition(self) -> bool:
        ...
        return np.amax(self.ulog.get_dataset(test_ratio_msg).data[test_ratio_field_names[0]]) > 0.0
...
class OpticalFlowCheck(EstimatorCheck):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            check_id='optical_flow',
            test_ratio_name=None,
