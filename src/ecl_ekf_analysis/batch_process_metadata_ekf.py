#! /usr/bin/env python3
"""
Performs a composite analysis of ekf log analysis meta data for all .ulg.csv files in the
specified directory Generates and saves histogram plots for the meta data in population_data.pdf
...
def get_arguments() -> Namespace:
    ...
    parser = argparse.ArgumentParser(
        description='Perform a composite analysis of ekf log analysis meta data for all .ulg.csv '
                    'files in the specified directory.')
    parser.add_argument(
        'directory_path', metavar='/some/directory/',
        help='The directory with the analysis result files (*.mdat.csv)')
...
def main() -> None:
    ...
    population_results = {
        ...
        'hagl_warning_pct':
            [float('NaN'), 'Percentage of logs with height above ground sensor warnings'],
        ...
        'mag_test_max_avg':
            [float('NaN'), 'The mean of the maximum  in-flight values of the magnetic field sensor '
                           'innovation consistency test ratio'],
        'mag_test_mean_avg':
            [float('NaN'), 'The mean of the mean in-flight value of the magnetic field sensor '
                           'innovation consistency test ratio'],
        'vel_test_max_avg':
            [float('NaN'), 'The mean of the maximum  in-flight values of the velocity sensor '
                           'innovation consistency test ratio'],
        'vel_test_mean_avg':
            [float('NaN'), 'The mean of the mean in-flight value of the velocity sensor innovation '
                           'consistency test ratio'],
        'pos_test_max_avg':
            [float('NaN'), 'The mean of the maximum  in-flight values of the position sensor '
                           'innovation consistency test ratio'],
        'pos_test_mean_avg':
            [float('NaN'), 'The mean of the mean in-flight value of the position sensor innovation '
                           'consistency test ratio'],
        'hgt_test_max_avg':
            [float('NaN'), 'The mean of the maximum  in-flight values of the height sensor '
                           'innovation consistency test ratio'],
        'hgt_test_mean_avg':
            [float('NaN'), 'The mean of the mean in-flight value of the height sensor innovation '
                           'consistency test ratio'],
        'tas_test_max_avg':
            [float('NaN'), 'The mean of the maximum  in-flight values of the airspeed sensor '
                           'innovation consistency test ratio'],
        'tas_test_mean_avg':
            [float('NaN'), 'The mean of the mean in-flight value of the airspeed sensor innovation '
                           'consistency test ratio'],
        'hagl_test_max_avg':
            [float('NaN'), 'The mean of the maximum in-flight values of the height above ground '
                           'sensor innovation consistency test ratio'],
        'hagl_test_mean_avg':
            [float('NaN'), 'The mean of the mean in-flight value of the height above ground sensor '
                           'innovation consistency test ratio'],
        'ofx_fail_pct_avg':
            [float('NaN'), 'The mean percentage of innovation test fails for the X axis optical '
                           'flow sensor'],
        'ofy_fail_pct_avg':
            [float('NaN'), 'The mean percentage of innovation test fails for the Y axis optical '
                           'flow sensor'],
        'imu_coning_max_avg':
            [float('NaN'), 'The mean of the maximum in-flight values of the IMU delta angle coning '
                           'vibration level (mrad)'],
        'imu_coning_mean_avg':
            [float('NaN'), 'The mean of the mean in-flight value of the IMU delta angle coning '
                           'vibration level (mrad)'],
        'imu_hfdang_max_avg':
            [float('NaN'), 'The mean of the maximum in-flight values of the IMU high frequency '
                           'delta angle vibration level (mrad)'],
        'imu_hfdang_mean_avg':
            [float('NaN'), 'The mean of the mean in-flight value of the IMU delta high frequency '
                           'delta angle vibration level (mrad)'],
        'imu_hfdvel_max_avg':
            [float('NaN'), 'The mean of the maximum in-flight values of the IMU high frequency '
                           'delta velocity vibration level (m/s)'],
        'imu_hfdvel_mean_avg':
            [float('NaN'), 'The mean of the mean in-flight value of the IMU delta high frequency '
                           'delta velocity vibration level (m/s)'],
        'obs_ang_median_avg':
            [float('NaN'), 'The mean of the median in-flight value of the output observer angular '
                           'tracking error magnitude (mrad)'],
        'obs_vel_median_avg':
            [float('NaN'), 'The mean of the median in-flight value of the output observer velocity '
                           'tracking error magnitude (m/s)'],
        'obs_pos_median_avg':
            [float('NaN'), 'The mean of the median in-flight value of the output observer position '
                           'tracking error magnitude (m)'],
    }
    ...
    for key in key_list:
        file.write(
            key + "," + str(population_results[key][0]) + "," + population_results[key][1] + "\n")
    ...
    single_log_results = {
        'filter_faults_max':
            [float('NaN'), 'Largest recorded value of the filter internal fault bitmask. Should '
                           'always be zero.'],
        'hagl_fail_percentage':
            [float('NaN'), 'The percentage of in-flight recorded failure events for the height '
                           'above ground sensor innovation consistency test.'],
        'hagl_percentage_amber':
            [float('NaN'), 'The percentage of in-flight height above ground sensor innovation '
                           'consistency test values > 0.5.'],
        'hagl_percentage_red':
            [float('NaN'), 'The percentage of in-flight height above ground sensor innovation '
                           'consistency test values > 1.0.'],
        'hagl_sensor_status':
            ['Pass', 'Height above ground sensor check summary. This sensor data is normally '
                     'sourced from a rangefinder sensor. A Fail result indicates a significant '
                     'error that caused a significant reduction in vehicle navigation performance '
                     'was detected. A Warning result indicates that error levels higher than '
                     'normal were detected but these errors did not significantly impact '
                     'navigation performance. A Pass result indicates that no amonalies were '
                     'detected and no further investigation is required'],
        'hagl_test_max':
            [float('NaN'), 'The maximum in-flight value of the height above ground sensor '
                           'innovation consistency test ratio.'],
        'hagl_test_mean':
            [float('NaN'), 'The mean in-flight value of the height above ground sensor innovation '
                           'consistency test ratio.'],
        'hgt_fail_percentage':
            [float('NaN'), 'The percentage of in-flight recorded failure events for the height '
                           'sensor innovation consistency test.'],
        'hgt_percentage_amber':
            [float('NaN'), 'The percentage of in-flight height sensor innovation consistency test '
                           'values > 0.5.'],
        'hgt_percentage_red':
            [float('NaN'), 'The percentage of in-flight height sensor innovation consistency test '
                           'values > 1.0.'],
        'hgt_sensor_status':
            ['Pass', 'Height sensor check summary. This sensor data can be sourced from either '
                     'Baro, GPS, range fidner or external vision system. A Fail result indicates '
                     'a significant error that caused a significant reduction in vehicle '
                     'navigation performance was detected. A Warning result indicates that error '
                     'levels higher than normal were detected but these errors did not '
                     'significantly impact navigation performance. A Pass result indicates that '
                     'no amonalies were detected and no further investigation is required'],
        'hgt_test_max':
            [float('NaN'), 'The maximum in-flight value of the height sensor innovation '
                           'consistency test ratio.'],
        'hgt_test_mean':
            [float('NaN'), 'The mean in-flight value of the height sensor innovation consistency '
                           'test ratio.'],
        'imu_coning_mean':
            [float('NaN'), 'Mean in-flight value of the IMU delta angle coning vibration '
                           'metric (rad)'],
        'imu_coning_peak':
            [float('NaN'), 'Peak in-flight value of the IMU delta angle coning vibration '
                           'metric (rad)'],
        'imu_hfdang_mean':
            [float('NaN'), 'Mean in-flight value of the IMU delta angle high frequency vibration '
                           'metric (rad)'],
        'imu_hfdang_peak':
            [float('NaN'), 'Peak in-flight value of the IMU delta angle high frequency vibration '
                           'metric (rad)'],
        'imu_hfdvel_mean':
            [float('NaN'), 'Mean in-flight value of the IMU delta velocity high frequency '
                           'vibration metric (m/s)'],
        'imu_hfdvel_peak':
            [float('NaN'), 'Peak in-flight value of the IMU delta velocity high frequency '
                           'vibration metric (m/s)'],
        'imu_sensor_status':
            ['Pass', 'IMU sensor check summary. A Fail result indicates a significant error '
                     'that caused a significant reduction in vehicle navigation performance was '
                     'detected. A Warning result indicates that error levels higher than normal '
                     'were detected but these errors did not significantly impact navigation '
                     'performance. A Pass result indicates that no amonalies were detected and '
                     'no further investigation is required'],
        'in_air_transition_time':
            [float('NaN'), 'The time in seconds measured from startup that the EKF transtioned '
                           'into in-air mode. Set to a nan if a transition event is not detected.'],
        'mag_percentage_amber':
            [float('NaN'), 'The percentage of in-flight consolidated magnetic field sensor '
                           'innovation consistency test values > 0.5.'],
        'mag_percentage_red':
            [float('NaN'), 'The percentage of in-flight consolidated magnetic field sensor '
                           'innovation consistency test values > 1.0.'],
        'mag_sensor_status':
            ['Pass', 'Magnetometer sensor check summary. A Fail result indicates a significant '
                     'error that caused a significant reduction in vehicle navigation performance '
                     'was detected. A Warning result indicates that error levels higher than '
                     'normal were detected but these errors did not significantly impact '
                     'navigation performance. A Pass result indicates that no amonalies were '
                     'detected and no further investigation is required'],
        'mag_test_max':
            [float('NaN'), 'The maximum in-flight value of the magnetic field sensor innovation '
                           'consistency test ratio.'],
        'mag_test_mean':
            [float('NaN'), 'The mean in-flight value of the magnetic field sensor innovation '
                           'consistency test ratio.'],
        'magx_fail_percentage':
            [float('NaN'), 'The percentage of in-flight recorded failure events for the X-axis '
                           'magnetic field sensor innovation consistency test.'],
        'magy_fail_percentage':
            [float('NaN'), 'The percentage of in-flight recorded failure events for the Y-axis '
                           'magnetic field sensor innovation consistency test.'],
        'magz_fail_percentage':
            [float('NaN'), 'The percentage of in-flight recorded failure events for the Z-axis '
                           'magnetic field sensor innovation consistency test.'],
        'master_status':
            ['Pass', 'Master check status which can be either Pass Warning or Fail. A Fail result '
                     'indicates a significant error that caused a significant reduction in vehicle '
                     'navigation performance was detected. A Warning result indicates that error '
                     'levels higher than normal were detected but these errors did not '
                     'significantly impact navigation performance. A Pass result indicates that '
                     'no amonalies were detected and no further investigation is required'],
        'ofx_fail_percentage':
            [float('NaN'), 'The percentage of in-flight recorded failure events for the optical '
                           'flow sensor X-axis innovation consistency test.'],
        'ofy_fail_percentage':
            [float('NaN'), 'The percentage of in-flight recorded failure events for the optical '
                           'flow sensor Y-axis innovation consistency test.'],
        'on_ground_transition_time':
            [float('NaN'), 'The time in seconds measured from startup  that the EKF transitioned '
                           'out of in-air mode. Set to a nan if a transition event '
                           'is not detected.'],
        'output_obs_ang_err_median':
            [float('NaN'), 'Median in-flight value of the output observer angular error (rad)'],
        'output_obs_pos_err_median':
            [float('NaN'), 'Median in-flight value of the output observer position error (m)'],
        'output_obs_vel_err_median':
            [float('NaN'), 'Median in-flight value of the output observer velocity error (m/s)'],
        'pos_fail_percentage':
            [float('NaN'), 'The percentage of in-flight recorded failure events for the velocity '
                           'sensor consolidated innovation consistency test.'],
        'pos_percentage_amber':
            [float('NaN'), 'The percentage of in-flight position sensor consolidated innovation '
                           'consistency test values > 0.5.'],
        'pos_percentage_red':
            [float('NaN'), 'The percentage of in-flight position sensor consolidated innovation '
                           'consistency test values > 1.0.'],
        'pos_sensor_status':
            ['Pass', 'Position sensor check summary. A Fail result indicates a significant error '
                     'that caused a significant reduction in vehicle navigation performance was '
                     'detected. A Warning result indicates that error levels higher than normal '
                     'were detected but these errors did not significantly impact navigation '
                     'performance. A Pass result indicates that no amonalies were detected and '
                     'no further investigation is required'],
        'pos_test_max':
            [float('NaN'), 'The maximum in-flight value of the position sensor consolidated '
                           'innovation consistency test ratio.'],
        'pos_test_mean':
            [float('NaN'), 'The mean in-flight value of the position sensor consolidated '
                           'innovation consistency test ratio.'],
        'tas_fail_percentage':
            [float('NaN'), 'The percentage of in-flight recorded failure events for the airspeed '
                           'sensor innovation consistency test.'],
        'tas_percentage_amber':
            [float('NaN'), 'The percentage of in-flight airspeed sensor innovation consistency '
                           'test values > 0.5.'],
        'tas_percentage_red':
            [float('NaN'), 'The percentage of in-flight airspeed sensor innovation consistency '
                           'test values > 1.0.'],
        'tas_sensor_status':
            ['Pass', 'Airspeed sensor check summary. A Fail result indicates a significant error '
                     'that caused a significant reduction in vehicle navigation performance was '
                     'detected. A Warning result indicates that error levels higher than normal '
                     'were detected but these errors did not significantly impact navigation '
                     'performance. A Pass result indicates that no amonalies were detected and '
                     'no further investigation is required'],
        'tas_test_max':
            [float('NaN'), 'The maximum in-flight value of the airspeed sensor innovation '
                           'consistency test ratio.'],
        'tas_test_mean':
            [float('NaN'), 'The mean in-flight value of the airspeed sensor innovation consistency '
                           'test ratio.'],
        'tilt_align_time':
            [float('NaN'), 'The time in seconds measured from startup that the EKF completed the '
                           'tilt alignment. A nan value indicates that the alignment had completed '
                           'before logging started or alignment did not complete.'],
        'vel_fail_percentage':
            [float('NaN'), 'The percentage of in-flight recorded failure events for the velocity '
                           'sensor consolidated innovation consistency test.'],
        'vel_percentage_amber':
            [float('NaN'), 'The percentage of in-flight velocity sensor consolidated innovation '
                           'consistency test values > 0.5.'],
        'vel_percentage_red':
            [float('NaN'), 'The percentage of in-flight velocity sensor consolidated innovation '
                           'consistency test values > 1.0.'],
        'vel_sensor_status':
            ['Pass', 'Velocity sensor check summary. A Fail result indicates a significant error '
                     'that caused a significant reduction in vehicle navigation performance was '
                     'detected. A Warning result indicates that error levels higher than normal '
                     'were detected but these errors did not significantly impact navigation '
                     'performance. A Pass result indicates that no amonalies were detected and '
                     'no further investigation is required'],
        'vel_test_max':
            [float('NaN'), 'The maximum in-flight value of the velocity sensor consolidated '
                           'innovation consistency test ratio.'],
        'vel_test_mean':
            [float('NaN'), 'The mean in-flight value of the velocity sensor consolidated '
                           'innovation consistency test ratio.'],
        'yaw_align_time':
            [float('NaN'), 'The time in seconds measured from startup that the EKF completed the '
                           'yaw alignment.'],
        'yaw_fail_percentage':
            [float('NaN'), 'The percentage of in-flight recorded failure events for the yaw '
                           'sensor innovation consistency test.'],
        'yaw_sensor_status':
            ['Pass', 'Yaw sensor check summary. This sensor data can be sourced from the '
                     'magnetometer or an external vision system. A Fail result indicates a '
                     'significant error that caused a significant reduction in vehicle navigation '
                     'performance was detected. A Warning result indicates that error levels '
                     'higher than normal were detected but these errors did not significantly '
                     'impact navigation performance. A Pass result indicates that no amonalies '
                     'were detected and no further investigation is required'],
    }
